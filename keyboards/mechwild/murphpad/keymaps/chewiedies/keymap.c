...
#define CALCAPP G(C(S(KC_C)))
#define BSPLAY  G(S(KC_SPC))
#define BSPREV  G(S(KC_PGDN))
#define BSNEXT  G(S(KC_PGUP))
#define BSTHMBD G(S(KC_L))
#define BSTHMBU G(S(KC_D))
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
    [_BASE] = LAYOUT(
                  BSPLAY,  KC_MUTE, BSPREV,  BSNEXT,
				  KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS,
                  KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
        CALCAPP,  KC_P4,   KC_P5,   KC_P6,   _______,
